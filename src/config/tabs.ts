...
export const tabs: TabItem[] = [
    ...
    { id: 'story', label: 'Contes', icon: Book, color: 'from-orange-500 to-amber-400', desc: 'Crée tes propres contes' },
    { id: 'creative_writing', label: 'Lab Écriture', icon: Palette, color: 'from-purple-500 to-pink-500', desc: 'Deviens un auteur star' },
